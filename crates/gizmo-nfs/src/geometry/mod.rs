...
use crate::types::{AssetHash, LodLevel, Mat4, NfsMaterialRange, NfsMeshPart, PartRole};
...
const MATERIAL_RANGES: u32 = 0x0013_4B02;
...
fn ordered_hashes(data: &[u8]) -> Vec<AssetHash> {
